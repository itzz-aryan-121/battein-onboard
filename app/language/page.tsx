      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col items-center justify-center pt-16 pb-0">
        ...
        {selectedLanguage && (
          <button 
            ...
            disabled={isLoading}
            className={`w-[300px] bg-[#F5BC1C] text-white font-medium py-2.5 px-4 rounded-lg hover:bg-amber-500 transition-colors animate-fadeInUp delay-400 ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
          >
            {isLoading ? (
