...
const RejectedPartnerRow = ({ partner }: { partner: any }) => (
  <tr className="hover:bg-gray-50">
    ...
    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
      <Link href={`/admin/partners/${partner._id}`} className="text-gray-600 hover:text-gray-900">
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Rejected Partners</h1>
          <p className="mt-1 text-sm text-gray-500">All rejected partners</p>
        </div>
      </div>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {partners.map((partner) => (
                <RejectedPartnerRow key={partner._id} partner={partner} />
              ))}
              {partners.length === 0 && (
                <tr>
